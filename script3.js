const cards = [
    { name: "Il Matto", description: "Rappresenta un momento di nuova avventura e inizio. Se appare nella situazione attuale, potresti trovarti in un periodo di grande cambiamento e apertura verso nuove opportunità, anche se potrebbero essere imprevedibili.", 
...
const cardElements1 = document.querySelectorAll('.card'); 
...
generateBtn.addEventListener('click', function() {
    ...
    cardElements[1].querySelector('p').innerText = shuffledCards[1].description1;

    cardElements[2].querySelector('h2').innerText = shuffledCards[2].name;
    cardElements[2].querySelector('img').src = shuffledCards[2].image;
    cardElements[2].querySelector('p').innerText = shuffledCards[2].description2;

    cardElements[3].querySelector('h2').innerText = shuffledCards[3].name;
    cardElements[3].querySelector('img').src = shuffledCards[3].image;
    cardElements[3].querySelector('p').innerText = shuffledCards[3].description3;

/*

    cardElements1[1].querySelector('h2').innerText = shuffledCards[1].name;
    cardElements1[1].querySelector('img').src = shuffledCards[1].
        image;
    cardElements1[1].querySelector('p').innerText = shuffledCards[1].description;

    cardElements1[2].querySelector('h2').innerText = shuffledCards[2].name;
    cardElements1[2].querySelector('img').src = shuffledCards[2].
        image;
    cardElements1[2].querySelector('p').innerText = shuffledCards[2].description;

    cardElements1[3].querySelector('h2').innerText = shuffledCards[3].name;
    cardElements1[3].querySelector('img').src = shuffledCards[3].
        image;
    cardElements1[3].querySelector('p').innerText = shuffledCards[3].description;
    */
}
